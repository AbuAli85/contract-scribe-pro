...
export const EMPLOYMENT_CONTENT: TemplateContent = {
  ...
  fields: [
    ...
    { key: "company_address", group: "Employer", groupAr: "صاحب العمل",
      ...
      placeholderEn: "Building 123, Way 5678, Al Khuwair, Muscat",
      placeholderAr: "مبنى 123، طريق 5678، الخوير، مسقط" },
    ...
    { key: "employee_nationality", group: "Employee", groupAr: "الموظف",
      ...
      type: "text", required: true, bilingual: true,
      placeholderEn: "Omani", placeholderAr: "عُماني" },
    ...
    { key: "job_title", group: "Role", groupAr: "المنصب",
      ...
      type: "text", required: true, bilingual: true,
      placeholderEn: "Senior Accountant", placeholderAr: "محاسب أول" },
    { key: "department", group: "Role", groupAr: "المنصب",
      labelEn: "Department", labelAr: "القسم",
      type: "text", required: false, bilingual: true,
      placeholderEn: "Finance", placeholderAr: "المالية" },
    ...
    { key: "company_signatory_title", group: "Signatures", groupAr: "التوقيعات",
      ...
      type: "text", required: true, bilingual: true,
      placeholderEn: "General Manager", placeholderAr: "المدير العام" },
  ],
