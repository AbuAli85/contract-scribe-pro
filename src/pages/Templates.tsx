...
const COPY = {
  ar: {
    ...
    feat3Title: "PDF جاهز للتوقيع",
    feat3Body: "تنزيل فوري بصيغة PDF — اطبع أو وقّع رقمياً.",
  ...
  en: {
    ...
    feat3Title: "Sign-ready PDF",
    feat3Body: "Instant download as PDF — print or sign digitally.",
